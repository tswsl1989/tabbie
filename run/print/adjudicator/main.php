...
Purpose :   Displays Summary of Adjudicator Print Modules.
...
<div id="content">
    ...
    <p>Welcome to the Adjudicator Print Module. Round <?echo $numdraws?> is in progress. Please choose from the drop down box above.</p>
